...
<html>
<head>
<title>shrio权限管理平台</title>
<meta http-equiv="pragma" content="no-cache">
<meta http-equiv="cache-control" content="no-cache">

<LINK rel="stylesheet" type="text/css" href="${baseurl}js/easyui/styles/default.css">
<%@ include file="/pages/jsp/common_css.jsp"%>
	...
	<%--	 <ul>
			<li><div>
					<a title="创建采购单" ref="1_1" href="#"
						rel="${baseurl} items/queryItems" icon="icon-log"><span
			...
			<li><div>
					<a title="提交采购单" ref="1_1" href="#"
						rel="${baseurl} /purchasing/order/orderList?type=1" icon="icon-log"><span
						class="icon icon-log">&nbsp;</span><span class="nav">提交采购单</span></a>
				</div></li>
			<li><div>
					<a title="部门经理审核" ref="1_1" href="#"
						rel="${baseurl} /purchasing/order/orderList?type=2" icon="icon-log"><span
						class="icon icon-log">&nbsp;</span><span class="nav">部门经理审核</span></a>
				</div></li>
			<li><div>
					<a title="总经理审核" ref="1_1" href="#"
						rel="${baseurl} /purchasing/order/orderList?type=3" icon="icon-log"><span
